...
object Plugins {
    ...
    object Version {
        ...
        // Release: https://github.com/JetBrains/kotlin/releases/tag/v1.5.31
        private const val KOTLIN = "1.5.31" // Released: 20-09-21

        // Release: https://github.com/JetBrains/kotlin/releases/tag/v1.6.0
        @Suppress("unused") const val KOTLIN_RC = "1.6.0" // Released: 16-11-21
        ...
        const val DETEKT = "1.19.0-RC2" // Released: 18-11-21
        ...
        const val MODULE_GRAPH_ASSERT = "1.7.0" // Released: 20-11-21
    ...
    const val ANDROID_NAVIGATION =
        "androidx.navigation:navigation-safe-args-gradle-plugin:${Versions.Android.Arch.Navigation.NAVIGATION_BETA}"
