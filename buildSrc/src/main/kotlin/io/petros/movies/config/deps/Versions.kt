...
object Versions {
    ...
    object Android {
        ...
        object Compose {
            ...
            const val COMPOSE = "1.0.0-beta09" // Released: 16-06-21
            ...
            object Accompanist {
                ...
                const val ACCOMPANIST = "0.12.0" // Released: 16-06-21
        ...
        object Arch {
            ...
            object DataStore {
                ...
                const val DATASTORE = "1.0.0-beta02" // Release: 16-06-21
        ...
        object Test {
            ...
            const val CORE_BETA = "1.4.0-beta02" // Released: 07-06-21
            @Suppress("unused") const val ESPRESSO = "3.3.0" // Released: 25-08-20
            const val ESPRESSO_BETA = "3.4.0-beta02" // Released: 07-06-21
            @Suppress("unused") const val J_UNIT = "1.1.2" // Released: 25-08-20
            const val J_UNIT_BETA = "1.1.3-beta02" // Released: 07-06-21
    ...
    object Di {
        ...
        object Koin {
            ...
            const val KOIN = "3.1.1" // Released: 24-06-21
