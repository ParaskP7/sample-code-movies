...
object Versions {
    ...
    object Kotlin {
        ...
        @Suppress("unused") const val COROUTINES = "1.3.8" // Released: 16-07-20
        const val COROUTINES_EAP = "$COROUTINES-${Plugins.Version.KOTLIN_EAP}"
    ...
    object Material {
        ...
        const val MATERIAL = "1.2.0" // Released: 04-08-20
    ...
    object Android {
        ...
        object Core {
            ...
            const val CONSTRAINT_LAYOUT_RC = "2.0.0-rc1" // Released: 29-07-20
        ...
        object Ktx {
            ...
            const val CORE = "1.3.1" // Released: 22-07-20
        ...
        object Arch {
            ...
            object Pagination {
                ...
                const val PAGING_ALPHA = "3.0.0-alpha04" // Release: 05-08-20
    ...
    object Net {
        ...
        object OkHttp {
            ...
            const val OK_HTTP = "4.8.0" // Released: 11-07-20
    ...
    object Test {
        ...
        object Spek {
            ...
            const val SPEK = "2.0.12" // Released: 05-07-20
