...
class AppInstrumentedTest {
    ...
    companion object {
        ...
        private const val MOVIES_TOOLBAR_FILTER_MONTH_AUGUST = "August"
        ...
        private const val MOVIE_MONTH_PICKER_MONTH_AUGUST = "Aug"
    ...
    private fun check_month_picker() {
        checkViewMoviesPicker(
            ...
            month = MOVIE_MONTH_PICKER_MONTH_AUGUST,
            withActionOkClick = true,
        )
    }
    ...
    private fun checkViewMoviesToolbarYear2020MonthApril(
        ...
        checkViewMoviesToolbar(
            ...
            filterYear = MOVIES_TOOLBAR_FILTER_YEAR_2020,
            filterMonthDisplayed = true,
            filterMonth = MOVIES_TOOLBAR_FILTER_MONTH_AUGUST,
        )
    }
